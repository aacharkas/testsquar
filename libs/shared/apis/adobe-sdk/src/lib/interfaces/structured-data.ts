...
/**
 * List of semantic elements (like headings, paragraphs, tables, figures) found in the document.
 * List is ordered based on the position of elements in the structure tree of the document.
 * For more information on various elements reported in this list, please visit https://opensource.adobe.com/pdftools-sdk-docs/beta/extract
 */
export type StructuredElement = ElementProperties & ElementPropertyNames;
  ...
  pages?: [
    {
      ...
      boxes: {
        /**
         * Media box of the page. Defines the boundaries of the physical medium on which the page is printed/displayed.
         */
        MediaBox?: [number, number, number, number];
        /**
         * Crop box of the page. Defines the visible region of the page. Content of the page clipped to this rectangle before print/display.
         */
...
/**
 * An element in the semantic document structure of the PDF
 */
export interface ElementProperties {
  /**
   * Bounding box enclosing the content items forming this element.
   * E.g. For a table cell, this value won't be the boundary of the cell, but union of the bounds of content (text, images etc.) inside the cell.
   * Not reported for elements which don't have any content items (like empty table cells).
   */
  Bounds?: [number, number, number, number];
  /**
   * Bounding box enlosing the content items, post clipping, forming this element. Only reported if any content item forming this element has an associated clip path.
   * Box in corresponding "Bounds" key always encloses this box.
   */
  ...
  Page?: number;
  /**
   * Path describing the location of the element in the structure tree. The type of the element and instance number are also part of the path.
   * For more information, please visit https://opensource.adobe.com/pdftools-sdk-docs/beta/extract
   */
  Path: string;
  /**
   * Text for the element in UTF-8 format. Only reported for text elements.
   * When inline elements are reported separately from parent block element, then this value has references to those inline elements.
   * For more information, please visit https://opensource.adobe.com/pdftools-sdk-docs/beta/extract
   */
  Text?: string;
  /**
  ...
  attributes?: {
    ...
    /**
     * Visual bounding box. Only reported for tables and table cells. Useful for getting bounds of the element including borders, if any. Use this to get bounding box of an empty tables/table cells
     */
    ...
    /**
     * Color of border(s), if any. Single color reported if all 4 borders are of same color.
     * If colors are different, each border color reported individually in order - top, bottom, left, right. Reported for table cells only.
     */
    BorderColor?:
      | ColorRGB
      | [ColorRGB | null, ColorRGB | null, ColorRGB | null, ColorRGB | null];
    /**
     * Style of border(s), if any. Single style reported if all 4 borders are of same style.
     * If styles are different, each border style reported individually in order - top, bottom, left, right. Reported for table cells only.
     */
    BorderStyle?:
      | (
          | 'None'
    ...
    /**
     * Thickness of border(s), if any, (in PDF user units) rounded off to nearest integer.
     * Single thickness value reported if all 4 borders are of same thickness.
     * If thickness varies, thickness of each border reported individually in order - top, bottom, left, right. Reported for table cells only.
     */
    ...
    Width?: number;
    /**
     * Background color (if any) of the element. Also used for reporting text highlight color.
     */
  ...
  Image?: {
    ...
    colorspace: {
      ...
      ICCProfile?: {
        /**
         * CompanyProfile's CMM identifier
         */
        'CMM ID': string;
        /**
         * ICC name of the color space
         */
        ColorSpace: 'Gray' | 'RGB' | 'RGB ' | 'CMYK' | 'Lab';
        /**
         * ICC name of the color space
         */
        Colorspace: 'Gray' | 'RGB' | 'CMYK' | 'Lab';
        /**
         * CompanyProfile's creator
         */
        Creator: string;
        /**
        ...
        Flags: string;
        /**
         * CompanyProfile's format version number
         */
        ICCVersion: string;
        /**
         * CompanyProfile illuminant
         */
        Illuminant: string;
        /**
         * ICC magic number
  ...
  /**
   * Ordered list of sub-elements of this element. **[Beta] Only reported when styling information is requested in the output**. See properties of each item for styling information.
   */
  Kids?: [
    ElementProperties & KidPropertyNames,
    ...(ElementProperties & KidPropertyNames)[]
  ];
  [k: string]: unknown;
}
export interface KidPropertyNames {
  [k: string]: unknown;
}
export interface ElementPropertyNames {
  [k: string]: unknown;
}
